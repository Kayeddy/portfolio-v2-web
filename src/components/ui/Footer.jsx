export default function Footer() {
  ...
  return (
    <footer className="flex items-end justify-between px-5 py-4 mt-14 text-body-4 sm:flex md:text-body-3">
      ...
      <button
        onClick={toTop}
        className="flex items-center col-span-2 space-x-2 group w-fit 2xl:text-body-1"
      >
