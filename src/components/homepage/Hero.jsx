...
export default function Hero({ hashRef }) {
  ...
  return (
    <section
      ref={hashRef}
      id="hero"
      className="relative flex items-center justify-center w-full h-screen antialiased select-none hero"
      aria-label="hero"
    >
      <div className="z-10 flex w-full  flex-col items-center text-title font-bold uppercase text-accent-300  2xl:space-y-16 2xl:text-[10vw]">
        <div className="title 2xl:mt-24 2xl:py-16">
          <h1
            ref={(el) => (titles.current[0] = el)}
            className="overflow-visible translate-y-96"
          >
            Hey, I&apos;m Eddy
          </h1>
        </div>
        <div className=" title 2xl:py-16">
          <h1
            ...
            className="overflow-visible text-transparent font-outline-3 md:font-outline-4 translate-y-96"
          >
            Hey, I&apos;m Eddy
          </h1>
        </div>
      ...
      <div
        ref={scroll}
        className="absolute right-0 flex flex-col items-center justify-center space-y-8 bottom-12"
      >
